...
from src.config.config import (
    ...
    MODELS_DIR, RAW_DIR, REPORTS_DIR
)
from src.features.feature_engineering import create_augmented_dataset
from src.utils.logger import log_training_session, log_comparison_session

MODEL_BASELINE    = os.path.join(MODELS_DIR, "action_model_baseline_new.h5")
MODEL_AUGMENTED   = os.path.join(MODELS_DIR, "action_model_augmented_new.h5")
ENCODER_BASELINE  = os.path.join(MODELS_DIR, "label_encoder_baseline_new.pkl")
...
def main():
    ...
    report_dir = os.path.join(REPORTS_DIR, "comparison_reports")
