...
print(f"  laptop_data  : {'OK' if os.path.isdir(LAPTOP_DIR) else 'MISSING — check folder name'}")
print(f"  webcam_data  : {'OK' if os.path.isdir(WEBCAM_DIR) else 'MISSING — check folder name'}")
