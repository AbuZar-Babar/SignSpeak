...
from src.config.actions_config import load_actions, SEQUENCE_LENGTH, PREDICTION_THRESHOLD, MODELS_DIR
...
def main():
    ...
    # Model Selection
    model_path = os.path.join(MODELS_DIR, "action_model_augmented.h5" if args.augmented else "action_model_baseline.h5")
    encoder_path = os.path.join(MODELS_DIR, "label_encoder_augmented.pkl" if args.augmented else "label_encoder_baseline.pkl")
