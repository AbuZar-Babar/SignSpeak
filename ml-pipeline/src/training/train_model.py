...
from src.config.actions_config import load_actions, DATA_PATH, SEQUENCE_LENGTH, NUM_SEQUENCES, BATCH_SIZE, EPOCHS, LEARNING_RATE, MODELS_DIR
...
def main():
    ...
    print(f"Training complete. Model saved to {model_path} and {encoder_path}")
