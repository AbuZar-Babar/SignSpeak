...
from .augmentation_inspector import validate_augmented_samples
from ..features.feature_engineering import SignLanguageAugmenter
...
def run_full_analysis(output_file: str = "analysis_report.json"):
    ...
    try:
        ...
        X, y = load_data(actions, [DATASET_FOLDERS["laptop"], DATASET_FOLDERS["mobile"]])
        ...
        try:
            X_lap, y_lap = load_data(actions, [DATASET_FOLDERS["laptop"]])
            X_mob, y_mob = load_data(actions, [DATASET_FOLDERS["mobile"]])
