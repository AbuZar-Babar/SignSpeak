...
from src.config.config import load_actions, SEQUENCE_LENGTH, BATCH_SIZE, EPOCHS, LEARNING_RATE
from src.data.ingestion import load_data
from src.pipelines.training_pipeline import build_model
...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "reports", "validation_results")
RANDOM_STATE = 42
N_FOLDS = 5
