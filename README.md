...
2. Run migrations in order (`20260327_signspeak_v1.sql` -> `20260327_admin_complaints_portal.sql` -> `20260515_organization_accounts.sql` -> `20260516_lock_down_security_definer_function_grants.sql` -> `20260517_platform_org_admin_creation.sql` -> `20260517_restrict_legacy_organization_creation.sql` -> `seed.sql`) from the [`supabase/`](./supabase/) folder.
3. Deploy the Supabase Edge Function in [`supabase/functions/admin-create-org-admin`](./supabase/functions/admin-create-org-admin).
4. Keep your `SUPABASE_URL` and `SUPABASE_PUBLISHABLE_KEY` handy.
